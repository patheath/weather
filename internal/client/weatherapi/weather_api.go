...
const Url = "https://api.weatherapi.com/v1/forecast.json?key=1293af9225504e1db29215820240404&q=02481&days=1&aqi=no&alerts=no"
...
func (wa WeatherApi) GetWeather() ([]byte, error) {
	client := &http.Client{}
	req, err := http.NewRequest(http.MethodGet, wa.Url, nil)
	if err != nil {
		log.Fatal(err)
	}
